            ...
            <div className="py-24 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <Link href={`/${lang}/projeler/tamamlanan-projeler`} className="group relative h-[500px] overflow-hidden bg-[#fcfcfc] border border-black/5 rounded-sm">
                            <Image
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-12 bg-gradient-to-t from-white via-white/80 to-transparent">
                                <h3 className="text-3xl font-light text-black mb-4 italic">{t.completed}</h3>
                                <p className="text-black/70 text-sm font-light mb-8 max-w-sm tracking-wide leading-relaxed">
                                    {t.completedDesc}
                                </p>
                        ...
                        <Link href={`/${lang}/projeler/devam-eden-projeler`} className="group relative h-[500px] overflow-hidden bg-[#fcfcfc] border border-black/5 rounded-sm">
                            <Image
                            ...
                            />
                            <div className="absolute inset-x-0 bottom-0 p-12 bg-gradient-to-t from-white via-white/80 to-transparent">
                                <h3 className="text-3xl font-light text-black mb-4 italic">{t.ongoing}</h3>
                                <p className="text-black/70 text-sm font-light mb-8 max-w-sm tracking-wide leading-relaxed">
                                    {t.ongoingDesc}
                                </p>
                                <span className="text-gold text-[10px] font-black tracking-[0.3em] border-b border-gold/30 pb-2 inline-block">

  ...
  return (
    <section className="h-screen w-full relative">
      ...
      >
        {slides?.length === 0 && (
          <SwiperSlide>
            <div className="h-full w-full bg-[#f8f8f8] flex items-center justify-center text-black/40 italic font-light tracking-widest text-sm uppercase">
                    ...
                    {buttonText && (
                      <div className="animate-in fade-in slide-in-from-left-20 duration-1000 delay-500">
                        <Link href={`/${lang}${link.startsWith('/') ? link : `/${link}`}`}>
                          <button className="group relative px-12 py-5 bg-[#b39359] text-white text-[11px] font-black tracking-[0.4em] transition-all hover:bg-black overflow-hidden">
